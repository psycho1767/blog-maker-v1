let apiKey = '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'; 
...
async function getpars(topicslist) {
    ...
    for (const item of topicslist) {
        sender(`درحال دریافت پاراگراف شماره ${topicslist.indexOf(item)+1}`)
        let messagepar = `درباره ${item}  در یک پاراگراف توضیح بده به زبان فارسی و هر پاراگراف بیشتر از پنج خط باشه`;
